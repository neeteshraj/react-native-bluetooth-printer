package com.bluetoothprinter.escpos;

import android.graphics.Bitmap;
import android.graphics.BitmapFactory;
import android.util.Base64;
import android.util.Log;
import com.bluetoothprinter.BluetoothService;
import com.bluetoothprinter.BluetoothServiceStateObserver;
import com.bluetoothprinter.escpos.command.sdk.Command;
import com.bluetoothprinter.escpos.command.sdk.PrintPicture;
import com.bluetoothprinter.escpos.command.sdk.PrinterCommand;
...
Print the image.
@param mBitmap The image to be printed.
@param nWidth The print width (58 or 80).
@param nMode The print mode.
@return byte[] The data representing the image in bytes.
*/
    ...
    public void printQRCode(String content, int size, int correctionLevel, final Promise promise) {
        try {
            ...
            // Convert the entered text into a QR code
