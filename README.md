...
```bash
npm install https://github.com/neeteshraj/react-native-bluetooth-printer.git --save
```
### Step2 ###
Refers to your JS files
```javascript
    import {BluetoothManager,BluetoothEscposPrinter,BluetoothTscPrinter} from 'react-native-bluetooth-printer';
```
...
#### printColumn(ReadableArray columnWidths,ReadableArray columnAligns,ReadableArray columnTexts,ReadableMap options) ####
  ...
  * columnWidths => int arrays, configs the width of each column, calculate by english character length. ex:the width of "abcdef" is 5 ,the width of "chinese" is 4.
...
```javascript
// Set printer alignment to CENTER
await BluetoothEscposPrinter.printerAlign(BluetoothEscposPrinter.ALIGN.CENTER);

// Set the text style to normal
await BluetoothEscposPrinter.setBlob(0);

// Print the text "Nitesh"
await BluetoothEscposPrinter.printText "Nitesh\n\r", {
  encoding: 'GBK',
  codepage: 0,
  widthtimes: 3,
  heigthtimes: 3,
...
// Print the text "Sales Order"
await BluetoothEscposPrinter.setBlob(0);
await BluetoothEscposPrinter.printText("Sales Order\n\r", {
  encoding: 'GBK',
  codepage: 0,
  widthtimes: 0,
  heigthtimes: 0,
...
// Set printer alignment to LEFT
await BluetoothEscposPrinter.printerAlign(BluetoothEscposPrinter.ALIGN.LEFT);

// Print various details
await BluetoothEscposPrinter.printText("Customer: Retail Customer\n\r", {});
await BluetoothEscposPrinter.printText("Order Number: xsd201909210000001\n\r", {});
...
// Print the table headers with appropriate alignments
await BluetoothEscposPrinter.printColumn(columnWidths,
  [BluetoothEscposPrinter.ALIGN.LEFT, BluetoothEscposPrinter.ALIGN.CENTER, BluetoothEscposPrinter.ALIGN.CENTER, BluetoothEscposPrinter.ALIGN.RIGHT],
  ["Product", 'Quantity', 'Unit Price', 'Amount'], {});

// Print the table rows with appropriate alignments and values
await BluetoothEscposPrinter.printColumn(columnWidths,
  [BluetoothEscposPrinter.ALIGN.LEFT, BluetoothEscposPrinter.ALIGN.LEFT, BluetoothEscposPrinter.ALIGN.CENTER, BluetoothEscposPrinter.ALIGN.RIGHT],
  ["React-Native Custom Development - Is this the right position for you to see?", '1', '32000', '32000'], {});
...
await BluetoothEscposPrinter.printText("Discounted Receivable: 64000.00\n\r", {});
await BluetoothEscposPrinter.printText("Membership Card Payment: 0.00\n\r", {});
await BluetoothEscposPrinter.printText("Point Deduction: 0.00\n\r", {});
...
await BluetoothEscposPrinter.printText("Express Number: None\n\r", {});
await BluetoothEscposPrinter.printText("Print Time: " + (dateFormat(new Date(), "yyyy-mm-dd h:MM:ss")) + "\n\r", {});
await BluetoothEscposPrinter.printText("--------------------------------\n\r", {});
...
// Print "Welcome to visit again" message
await BluetoothEscposPrinter.printText("Welcome to visit again\n\r\n\r\n\r", {});
